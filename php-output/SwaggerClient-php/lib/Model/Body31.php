...
'index' => 'getIndex'    ];
     ...
     * Sets assignee_id
     *
     * @param int $assignee_id internal id of an user in Vincere
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string $text the text that is contained (case-insensitive) in the field content or subject of the activity
     *
     * @return $this
     */
