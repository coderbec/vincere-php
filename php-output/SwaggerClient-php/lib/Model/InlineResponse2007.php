...
'gender' => 'string',
'gender_title' => 'string',
'highest_job_application_stage' => 'string',
'home_phone' => 'string',
'id' => 'int',
'ielts_score' => 'string',
'keyword' => 'string',
...
'gender' => null,
'gender_title' => null,
'highest_job_application_stage' => null,
'home_phone' => null,
'id' => null,
'ielts_score' => null,
'keyword' => null,
...
'highest_job_application_stage' => 'highest_job_application_stage',
...
'highest_job_application_stage' => 'setHighestJobApplicationStage',
...
'email_subscribed' => 'setEmailSubscribed'    ];
...
'highest_job_application_stage' => 'getHighestJobApplicationStage',
...
'email_subscribed' => 'getEmailSubscribed'    ];
...
const AVAILABILITY_DO_NOT_CALL = 'DO_NOT_CALL';
const AVAILABILITY_TO_BE_DELETED = 'TO_BE_DELETED';
const AVAILABILITY_UNAVAILABLE = 'UNAVAILABLE';
const AVAILABILITY_SHORTLISTED = 'SHORTLISTED';
const AVAILABILITY_SENT = 'SENT';
const AVAILABILITY__1_ST_INTERVIEW = '1ST_INTERVIEW';
const AVAILABILITY__2_ND_INTERVIEW = '2ND_INTERVIEW';
const AVAILABILITY_OFFERED = 'OFFERED';
const AVAILABILITY_PLACED = 'PLACED';
const AVAILABILITY_PLACEMENT_PERMANENT = 'PLACEMENT_PERMANENT';
const AVAILABILITY_PLACEMENT_CONTRACT = 'PLACEMENT_CONTRACT';
const AVAILABILITY_PLACEMENT_TEMP = 'PLACEMENT_TEMP';
const AVAILABILITY_INVOICED = 'INVOICED';
...
const HIGHEST_JOB_APPLICATION_STAGE_SHORTLISTED = 'SHORTLISTED';
const HIGHEST_JOB_APPLICATION_STAGE_SENT = 'SENT';
const HIGHEST_JOB_APPLICATION_STAGE_FIRST_INTERVIEW = 'FIRST_INTERVIEW';
const HIGHEST_JOB_APPLICATION_STAGE_SECOND_INTERVIEW = 'SECOND_INTERVIEW';
const HIGHEST_JOB_APPLICATION_STAGE_THIRD_INTERVIEW = 'THIRD_INTERVIEW';
const HIGHEST_JOB_APPLICATION_STAGE_FOURTH_INTERVIEW = 'FOURTH_INTERVIEW';
const HIGHEST_JOB_APPLICATION_STAGE_FIFTH_INTERVIEW = 'FIFTH_INTERVIEW';
const HIGHEST_JOB_APPLICATION_STAGE_LAST_INTERVIEW_ROUND = 'LAST_INTERVIEW_ROUND';
const HIGHEST_JOB_APPLICATION_STAGE_OFFERED = 'OFFERED';
const HIGHEST_JOB_APPLICATION_STAGE_PLACED = 'PLACED';
const HIGHEST_JOB_APPLICATION_STAGE_PLACEMENT_PERMANENT = 'PLACEMENT_PERMANENT';
const HIGHEST_JOB_APPLICATION_STAGE_PLACEMENT_CONTRACT = 'PLACEMENT_CONTRACT';
const HIGHEST_JOB_APPLICATION_STAGE_PLACEMENT_TEMP = 'PLACEMENT_TEMP';
const HIGHEST_JOB_APPLICATION_STAGE_INVOICED = 'INVOICED';
...
self::AVAILABILITY_DO_NOT_CALL,
self::AVAILABILITY_TO_BE_DELETED,
self::AVAILABILITY_UNAVAILABLE,
self::AVAILABILITY_SHORTLISTED,
self::AVAILABILITY_SENT,
self::AVAILABILITY__1_ST_INTERVIEW,
self::AVAILABILITY__2_ND_INTERVIEW,
self::AVAILABILITY_OFFERED,
self::AVAILABILITY_PLACED,
self::AVAILABILITY_PLACEMENT_PERMANENT,
self::AVAILABILITY_PLACEMENT_CONTRACT,
self::AVAILABILITY_PLACEMENT_TEMP,
self::AVAILABILITY_INVOICED,        ];
    }
    /**
     * Gets allowable values of the enum
     *
...
self::GENDER_NO_VALUE,        ];
     ...
     * @return string[]
     */
    public function getHighestJobApplicationStageAllowableValues()
    {
        return [
            self::HIGHEST_JOB_APPLICATION_STAGE_SHORTLISTED,
self::HIGHEST_JOB_APPLICATION_STAGE_SENT,
self::HIGHEST_JOB_APPLICATION_STAGE_FIRST_INTERVIEW,
self::HIGHEST_JOB_APPLICATION_STAGE_SECOND_INTERVIEW,
self::HIGHEST_JOB_APPLICATION_STAGE_THIRD_INTERVIEW,
self::HIGHEST_JOB_APPLICATION_STAGE_FOURTH_INTERVIEW,
self::HIGHEST_JOB_APPLICATION_STAGE_FIFTH_INTERVIEW,
self::HIGHEST_JOB_APPLICATION_STAGE_LAST_INTERVIEW_ROUND,
self::HIGHEST_JOB_APPLICATION_STAGE_OFFERED,
self::HIGHEST_JOB_APPLICATION_STAGE_PLACED,
self::HIGHEST_JOB_APPLICATION_STAGE_PLACEMENT_PERMANENT,
self::HIGHEST_JOB_APPLICATION_STAGE_PLACEMENT_CONTRACT,
self::HIGHEST_JOB_APPLICATION_STAGE_PLACEMENT_TEMP,
self::HIGHEST_JOB_APPLICATION_STAGE_INVOICED,        ];
    }
    /**
     * Gets allowable values of the enum
     *
...
self::SALARY_TYPE_MONTHLY,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['highest_job_application_stage'] = isset($data['highest_job_application_stage']) ? $data['highest_job_application_stage'] : null;
        ...
        $this->container['email_subscribed'] = isset($data['email_subscribed']) ? $data['email_subscribed'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getHighestJobApplicationStageAllowableValues();
        if (!is_null($this->container['highest_job_application_stage']) && !in_array($this->container['highest_job_application_stage'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'highest_job_application_stage', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets availability
     *
     * @param string $availability The candidate availability for job application.
     *
     * @return $this
     */
    ...
    /**
     * Gets highest_job_application_stage
     *
     * @return string
     */
    public function getHighestJobApplicationStage()
    {
        return $this->container['highest_job_application_stage'];
    }

    /**
     * Sets highest_job_application_stage
     *
     * @param string $highest_job_application_stage the highest stage computed from job applications of the candidate
     *
     * @return $this
     */
    public function setHighestJobApplicationStage($highest_job_application_stage)
    {
        $allowedValues = $this->getHighestJobApplicationStageAllowableValues();
        if (!is_null($highest_job_application_stage) && !in_array($highest_job_application_stage, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'highest_job_application_stage', must be one of '%s'",
                    implode("', '", $allowedValues)
        ...
        $this->container['highest_job_application_stage'] = $highest_job_application_stage;
    ...
    /**
     * Gets email_subscribed
     *
     * @return bool
     */
    public function getEmailSubscribed()
    {
        return $this->container['email_subscribed'];
    }

    /**
     * Sets email_subscribed
     *
     * @param bool $email_subscribed That \"true\" is subscribed, \"false\" is unsubscribed
     *
     * @return $this
     */
    public function setEmailSubscribed($email_subscribed)
    {
        $this->container['email_subscribed'] = $email_subscribed;
