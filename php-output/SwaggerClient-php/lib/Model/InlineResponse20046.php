...
const STATUS_UNSUPPORT = 'UNSUPPORT';
...
self::STATUS_DONE,        ];
     ...
     * Sets data
     *
     * @param string $data content in converted format
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status status of the conversion progress
     *
     * @return $this
     */
