...
'notice_period' => 'float',
'current_address' => '\Swagger\Client\Model\PlacementidcandidatedetailCurrentAddress'    ];
...
self::GENDER_NO_VALUE,        ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payslip_email'] === null) {
            $invalidProperties[] = "'payslip_email' can't be null";
        }
     ...
     *
     * @return \Swagger\Client\Model\PlacementidcandidatedetailCurrentAddress
     */
     ...
     *
     * @param \Swagger\Client\Model\PlacementidcandidatedetailCurrentAddress $current_address current_address
     *
     * @return $this
     */
